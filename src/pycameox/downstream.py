...
def general_iplot(datasets: RunsSet,
    ...
    layout: Dict[str,
                 Any] = {'legend': {'x': +0.1,
                         ...
                         'title': title,
                         'xaxis': {'title': f'Negative-pseudo-log-likelihood of {protA} variants (rel. to WT)',
                                   'type': 'linear',
                                   },
                         'yaxis': {'title': f'Negative-pseudo-log-likelihood of {protB} variants (rel. to WT)',
                                   'type': 'linear',
                                   },
                         ...
                         'updatemenus': [{'buttons': [{"args": [{'marker.color': None},
                                         ...
                                         {"buttons": [{"args": [{'type': 'scatter',
                                                      ...
                                                      {"args": [{'type': 'histogram2dcontour',
                                                       ...
                                                       {'xaxis.title': f'Normalized density of variants in the negative-pseudo-log-likelihood space for {protA} (rel. to WT)',
                                                        'xaxis.type': 'lin',
                                                        'yaxis.title': f'Normalized density of variants in the negative-pseudo-log-likelihood space for {protB} (rel. to WT)',
                                                        'yaxis.type': 'lin',
...
def redundancy_iplot(redundancy: pd.DataFrame,
    ...
    layout: Dict[str, Any] = {
        ...
        'title': title,
        'xaxis': {
            'title': f'Negative-pseudo-log-likelihood of {protA} variants (rel. to WT)',
            'type': 'linear',
        },
        'yaxis': {
            'title': f'Negative-pseudo-log-likelihood of {protB} variants (rel. to WT)',
            'type': 'linear',
        },
        'coloraxis': {
            'colorscale': ('Reds'),
